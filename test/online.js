    ...
    function component(object) {
      ...
      this.create = function () {
        ...
        network.silent(url, function (json) {
          ...
          } else _this.empty('ÐžÐ¹, Ð¼Ñ‹ Ð½Ðµ Ð½Ð°ÑˆÐ»Ð¸ (' + object.search + ')');
        }, function (a, c) {
          _this.empty('ÐžÑ‚Ð²ÐµÑ‚: ' + network.errorDecode(a, c));
        });
      ...
      this.buildFilterd = function (select_season) {
        ...
        if (object.movie.number_of_seasons) {
          add('voice', 'ÐŸÐµÑ€ÐµÐ²Ð¾Ð´');
          add('season', 'Ð¡ÐµÐ·Ð¾Ð½');
        }
      ...
      this.getFile = function (element, show_error) {
        ...
        if (show_error) Lampa.Noty.show('ÐÐµ ÑƒÐ´Ð°Ð»Ð¾ÑÑŒ Ð¸Ð·Ð²Ð»ÐµÑ‡ÑŒ ÑÑÑ‹Ð»ÐºÑƒ');
      };
